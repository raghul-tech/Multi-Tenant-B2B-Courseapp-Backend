...
from .views import LoginView, accounts_create,  accounts_detail, accounts_edit,account_create_superuser,account_delete_superuser,accounts_create_admin
from .tenantadmin.view import AccountAdminView
from rest_framework.routers import DefaultRouter
from .tenantuser.view import AccountUserView
...
urlpatterns = [
   ...
   #path('create/tenantadmin/',AccountAdminCreate.as_view,name='accounts_create_admin'),
